...
def model_bag_of_words(training, testing, training_cat, testing_cat):
    ...
    selector, training_features = select_features(5, reduced_training, training_cat)
    selector_test, testing_features = select_features(5, reduced_testing, testing_cat)
